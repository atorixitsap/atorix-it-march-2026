...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const redirectPath =
          ROLE_PREDICT[user.role] || "/admin/dashboard";
  ...
  return (
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: "url('https://res.cloudinary.com/dh72ujjxx/image/upload/v1762412853/be49eb5e228213232ecaa69f98020834_ibqyn7.jpg')" }}
    >
