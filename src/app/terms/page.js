            ...
            >
              <div className="mb-10">
                <p className="text-lg leading-relaxed">
                  ...
                  of the Atorix IT Solutions website, services, and products
                  ("Services"). Please read these Terms carefully, and contact
                  us if you have any questions. By accessing or using our
              ...
              <div className="mb-10">
                ...
                <p>
                  ...
                  not agree to these Terms, you must not access or use our
                  Services. We recommend that you print a copy of these Terms
              ...
              <div className="mb-10">
                ...
                <p>
                  ...
                  changes we made, as they are binding on you. Your continued
              ...
              <div className="mb-10">
                ...
                <p className="mb-4">
                  ...
                  withdraw, discontinue or change all or any part of our
                  Services without notice. We will not be liable to you if for
                  any reason our Services are unavailable at any time or for any
                  period.
                </p>
                <p>
                  You are responsible for making all arrangements necessary for
                  you to have access to our Services. You are also responsible
                  for ensuring that all persons who access our Services through
                  your internet connection are aware of these Terms and other
                  applicable terms and conditions, and that they comply with
                  them.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <p className="mb-4">
                  If you create an account with us, you must treat your username
                  and password as confidential, and you must not disclose it to
                  any other person. You agree to notify us immediately of any
                  unauthorized access to your account or password, or any other
                  breach of security.
                </p>
                <p>
                  We have the right to disable any user account at any time, if
                  in our reasonable opinion you have failed to comply with any
              ...
              <div className="mb-10">
                ...
                <p className="mb-4">
                  ...
                  rights in our Services, and in the material published on it.
              ...
              <div className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2 mb-4">
                  ...
                  <li>
                    To impersonate or attempt to impersonate Atorix IT
                    Solutions, an Atorix IT Solutions employee, another user, or
                    any other person or entity.
                  </li>
                  <li>
                    To engage in any other conduct that restricts or inhibits
                    anyone's use or enjoyment of the Services, or which may harm
                    Atorix IT Solutions or users of the Services.
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-10">
                <h2 className="text-2xl font-semibold mb-4">
                  7. Service Description and Limitation of Liability
                </h2>
                <p className="mb-4">
                  Atorix IT Solutions provides SAP implementation and related IT
                  consulting services as described on our website. While we
                  strive to provide high-quality services, we make no guarantees
                  or warranties about the results of our services.
                </p>
                <p className="mb-4">
                  To the fullest extent permitted by law, Atorix IT Solutions
                  excludes all liability for any direct, indirect, incidental,
              ...
              <div className="mb-10">
                ...
                <p>
                  You agree to defend, indemnify, and hold harmless Atorix IT
              ...
              <div className="mb-10">
                ...
                <p>
                  ...
                  jurisdiction of the courts located in Pune, Maharashtra,
              ...
              <div className="mb-10">
                ...
                <p>
                  These Terms, our Privacy Policy, and any other agreements or
                  terms referenced herein constitute the sole and entire
                  agreement between you and Atorix IT Solutions regarding the
              ...
              <div className="mb-10">
                ...
                <ul className="list-none space-y-2 mt-4">
                  ...
                  <li>
                    <strong>Address:</strong> 3rd Floor, Office No. C 305 DP
