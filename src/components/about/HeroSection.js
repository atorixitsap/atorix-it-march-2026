...
export default function AboutHeroSection() {
  const description =
    "At Atorix IT, we are dedicated to delivering innovative technology solutions that drive business growth. Our team of experts combines creativity with technical expertise to build cutting-edge applications and services that help our clients succeed in the digital age.";
    ...
    <section className="relative overflow-hidden flex items-center justify-center bg-background text-justify">
      <div className="relative w-full max-w-7xl h-[500px] sm:h-[600px] md:h-[650px] lg:h-[700px] xl:h-[750px] mx-auto">
        ...
        <div className="absolute inset-0">
          ...
          >
            <source
              src="https://res.cloudinary.com/deni4qbla/video/upload/v1757913598/Futuristic_interface___HUD_sound_effects_720p_e65uch.mp4"
              type="video/mp4"
            />
          ...
          >
            <source
              src="https://res.cloudinary.com/deni4qbla/video/upload/v1760692802/VID_20251017141956_hdthph.mp4"
              type="video/mp4"
            />
            Your browser does not support the video tag.
          </video>
          ...
          <div className="flex justify-start mb-4 sm:mb-6 lg:mb-8">
            ...
            >
              ...
              <h2 className="inline-block text-3xl font-bold text-white dark:text-white">
                About Us
                <span className="block mt-2 h-[4px] w-3/5 bg-gradient-to-r from-white via-white to-transparent"></span>
              </h2>
