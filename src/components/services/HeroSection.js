    ...
    cards: [
      {
        ...
        details: {
          description:
            "Next-generation ERP suite that transforms your business processes with intelligent automation and real-time insights.",
          features: [
      ...
      },
      {
        ...
        details: {
          description:
            "Business Technology Platform that connects data, processes, and people to accelerate digital transformation.",
          features: [
      ...
      },
      {
        ...
        details: {
          description:
            "Comprehensive business management solution designed specifically for small and medium enterprises.",
          features: [
      ...
      },
      {
        ...
        details: {
          description:
            "Financial accounting and controlling module that provides complete financial management capabilities.",
          features: [
            "General Ledger",
      ...
      },
      {
        ...
        details: {
          description:
            "Expert SAP consulting services to guide your digital transformation journey and optimize business processes.",
          features: [
  ...
  return (
    <section className="py-12 md:py-16 relative bg-white dark:bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute top-40 right-0 sm:right-10 w-52 h-52 sm:w-80 sm:h-80 bg-gradient-to-r from-cyan-500/6 to-blue-600/6 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute -bottom-8 left-4 sm:left-20 w-48 h-48 sm:w-72 sm:h-72 bg-gradient-to-r from-blue-600/6 to-sky-500/6 rounded-full filter blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-6 lg:px-8 xl:px-12 relative z-10 h-full max-w-7xl">
        ...
        <div className="lg:hidden flex flex-col py-4 px-4 w-full">
          ...
          >
            ...
            <h1 className="text-3xl font-extrabold mb-3 text-black dark:text-white relative tracking-tight">
              {title}
            </h1>
            <p className="text-base text-black-300 mb-8 leading-relaxed px-2">
              {description}
            </p>
          </motion.div>
                ...
                >
                  ...
                  <div className="relative z-10 p-5 flex flex-col flex-1">
                    <div className="flex-1 flex flex-col justify-end">
                      ...
                      <p className="text-sm text-gray-200 mb-3 line-clamp-2 text-justify">
                        ...
                        <div className="absolute inset-0 p-6">
                          ...
                          >
                            <div className="space-y-4">
                              ...
                              <p
                                className="text-white/90 leading-relaxed drop-shadow-md"
                                style={{
                                  fontSize: "0.875rem",
                                  lineHeight: "1.5rem",
                                }}
