  ...
  return (
    <section className="relative py-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        {/* Gradient layer */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-primary/5 dark:from-primary/5 dark:to-primary/2"></div>

        {/* Dot grid */}
        <div
          className="
          absolute inset-0
          bg-[radial-gradient(circle,rgba(0,0,0,0.08)_1.2px,transparent_1.2px)]
          dark:bg-[radial-gradient(circle,rgba(255,255,255,0.15)_1.2px,transparent_1.2px)]
          bg-[size:20px_20px]
        "
        ></div>

        {/* Glow blobs */}
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[140px]" />
      ...
      <div className="container-custom relative z-10">
        ...
        {/* CARD */}
        <div className="relative max-w-xl mx-auto mt-14 rounded-[30px] bg-card border border-border shadow-[0_20px_60px_rgba(0,0,0,0.12)] bg-white dark:bg-gray-900">
          {/* IMAGE */}
